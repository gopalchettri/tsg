...
# ── Treatment-plan slice — lives in app.api.schemas_treatment; resolved LAZILY (PEP 562) so neither import order
#    cycles (schemas_treatment imports its shared helpers from here). Restricted to the moved names, and
...
def __getattr__(name: str):
    ...
    import importlib
    value = getattr(importlib.import_module("app.api.schemas_treatment"), name)
    globals()[name] = value
    return value
