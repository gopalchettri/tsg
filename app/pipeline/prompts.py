...
def scenario_prompt(base_ctx: dict[str, Any], threat_type: str | None, threat_name: str | None,
    ...
    system_content = (
            ...
            "there. The asset, by its context-given name, is the subject of every field except "
            "the title, which names only the impact; supporting systems appear only as the path "
            "the threat travels or as operational context.\n"
            ...
            "scenario_title: a short title naming the impact only. Do NOT include the asset's "
            "name - it is shown next to the title.\n"
