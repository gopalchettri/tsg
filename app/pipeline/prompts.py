...
def treatment_prompt(snapshot: dict[str, Any]) -> list[dict]:
    ...
    system_content = (
        ...
        "risk_assessment block; cite those supplied values verbatim where rule 6 requires "
        "it.\n"
        "5) Never name a person or a specific entity/organization — owners are roles or "
        "teams.\n"
        "6) CALIBRATE TO THE RISK — the context's risk_assessment block is the register's "
        "scored verdict and MUST drive the plan, not merely accompany it:\n"
        ...
        "actions — never assign one uniform priority across the plan.\n"
        ...
        "   - impacted_business_division, when present, is organizational context: choose "
